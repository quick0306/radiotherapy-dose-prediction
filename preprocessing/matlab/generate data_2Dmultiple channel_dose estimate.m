...
% Lee-Avoid2, Perez-NA, Tompodung-NA, Kane-NA, DASSRAM-NA, SAGASTA-NA
% ROJAS-NA, CICCONE-NA, ELIAS-NA, GARATE-NA
OptStructure = ["NA"]
SKIN ='BODY';
...
save('data_SAGASTA_NEW.mat','structset_2d_channel', 'doseset_2d')
display('done')
